...
${OBJECTDIR}/_ext/1843591534/I2C.o: ../../../../../../P4/MX7CKServer/TCPIP/Demo\ App/I2C.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1843591534" 
	@${RM} ${OBJECTDIR}/_ext/1843591534/I2C.o.d 
	@${RM} ${OBJECTDIR}/_ext/1843591534/I2C.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1843591534/I2C.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -DCFG_INCLUDE_PIC32_ETH_SK_ETH795 -D_SUPRESS_PLIB_WARNING -D_DISABLE_OPENADC10_CONFIGPORT_WARNING -I".." -I"../../Microchip/Include" -I"../../../Microchip/Include" -I"../../../Microchip/Include/TCPIP Stack" -I"../Configs" -Wall -MMD -MF "${OBJECTDIR}/_ext/1843591534/I2C.o.d" -o ${OBJECTDIR}/_ext/1843591534/I2C.o "../../../../../../P4/MX7CKServer/TCPIP/Demo App/I2C.c"    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
